      ...
      <main className="flex-1 pt-28 pb-20">
        <article className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-text-muted leading-[1.8] mb-8">
            Vi er her for at hjælpe jer med spørgsmål om omskæringsprocedurer. Vores team
            bestræber sig på at give jer tydelig information og støtte gennem hele forløbet.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="glass-card p-6">
              ...
              <p className="text-text-muted leading-[1.8]">
                Tidsbestilling foregår online. Hvis I foretrækker det, kan I også skrive via
                kontaktformularen, så vender vi hurtigt tilbage.
              </p>
            </div>
          </div>

          <section className="glass-card p-6">
            <h3 className="font-heading text-2xl text-secondary mb-3">Find Specialklinik Taastrup</h3>
            <p className="text-text-muted leading-[1.8]">
              Taastrup S-togsstation ligger cirka 450 meter fra klinikken, og der er gratis
